...
export const alt = "Mind Builder — wish it, we build it";
  ...
  return new ImageResponse(
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 22 }}>
        ...
        <span style={{ fontSize: 60, fontWeight: 700, letterSpacing: -1 }}>Builder</span>
      </div>
      <div
        style={{
          display: "flex",
      ...
      >
        <span>Wish it.&nbsp;</span>
        <span style={{ color: "#16b88a" }}>We build it.</span>
      </div>
      <div
